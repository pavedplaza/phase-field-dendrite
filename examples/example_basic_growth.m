% Basic Dendritic Growth Example with Video Output
% 基础枝晶生长示例（含视频输出）
%
%
% Output videos | 输出视频:
...
fprintf('========================================================\n');
fprintf('  Basic Dendritic Growth Example | 基础枝晶生长示例\n');
fprintf('========================================================\n');
...
params.tip_tracking = false;       % Disable tip tracking for this demo | 禁用尖端追踪
...
if params.save_video
    fprintf('  - Video: basic_growth_combined.mp4 (3 subplots: phase, concentration, C/C∞)\n');
end
fprintf('========================================================\n\n');
